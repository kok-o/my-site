...
/** Stagger container with faster children — for skill tags */
...
/** Tighter viewport — triggers later (for elements deeper in page) */
export const VIEWPORT_ONCE_TIGHT = { once: true, margin: '-120px' } as const
